function  [ GPSP4 ,GLOP4 , BDSP4] = Get_P4GRC(POSItion,OBSER,Sites_Info,Cutoff)
...
%     if gpsl>gpssate
%         POSItion.glox(:,gpssate+1:gpsl)=0;POSItion.gloy(:,gpssate+1:gpsl)=0;
%         POSItion.gloz(:,gpssate+1:gpsl)=0;
%     end
