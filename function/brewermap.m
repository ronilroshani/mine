...
vec = {'BrBG';'PiYG';'PRGn';'PuOr';'RdBu';'BuRd';'RdGy';'RdYlBu';'RdYlGn';'Spectral';'Accent';'Dark2';'Paired';'Pastel1';'Pastel2';'Set1';'Set2';'Set3';'Blues';'BuGn';'BuPu';'GnBu';'Greens';'Greys';'OrRd';'Oranges';'PuBu';'PuBuGn';'PuRd';'Purples';'RdPu';'Reds';'YlGn';'YlGnBu';'YlOrBr';'YlOrRd'};
%
...
switch tok % ColorName
	...
	case 'RdBu'
		...
		typ = 'Diverging';
    case 'BuRd'
        rgb = [5,48,97;33,102,172;5,113,176;67,147,195;103,169,207;146,197,222;209,229,240;255,255,255;253,219,199;244,165,130;239,138,98;214,96,77;202,0,32;78,24,43;103,0,31];		typ = 'Diverging';    
        typ = 'Diverging';
    case 'RdGy'
