...
%
% DESCRIPTION
%   Object to manage a useful functions / standard parameters of GPS
%   Under development no methods are used up to now...
%
% EXAMPLE
%   go = goGNSS();
%
% FOR A LIST OF CONSTANTs and METHODS use doc GNSS
%% ------------------------------------------------------------------------
...
classdef goGNSS < handle
    ...
    methods (Static, Access = 'public')
        ...
        function [constellations] = initConstellation(GPS_flag, GLO_flag,BDS_flag, GAL_flag, QZS_flag, SBS_flag)
