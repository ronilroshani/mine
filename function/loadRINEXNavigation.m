...
if strcmp(satsys,'R')
    [brdc.eph, brdc.sat] = getEphemerisFromNavigationBodyR(body,satsys,brdc.hdr.version);
elseif strcmp(satsys,'G')
    [brdc.eph, brdc.sat] = getEphemerisFromNavigationBodyG(body,satsys,brdc.hdr.version);
elseif strcmp(satsys,'E')
    [brdc.eph, brdc.sat] = getEphemerisFromNavigationBodyE(body,satsys,brdc.hdr.version);
elseif strcmp(satsys,'C')
    [brdc.eph, brdc.sat] = getEphemerisFromNavigationBodyC(body,satsys,brdc.hdr.version);
end
